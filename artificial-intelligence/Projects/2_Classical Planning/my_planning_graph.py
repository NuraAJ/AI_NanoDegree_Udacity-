...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any([~effect in actionA.effects for effect in actionB.effects]) or any([~effects in actionB.effects for effects in actionA.effects])
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any([~effect in actionA.preconditions for effect in actionB.effects]) or any([~effects in actionB.preconditions for effects in actionA.effects])
...
#         raise NotImplementedError
        return any(self.parent_layer.is_mutex(a, b) for a in actionA.preconditions for b in actionB.preconditions)
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        return all(self.parent_layer.is_mutex(action_a, action_b) for action_a in self.parents[literalA] for action_b in self.parents[literalB])
        ...
        for i, layer in enumerate(self.literal_layers):
            ...
            for goal in self.goal:
                ...
                if goal not in layer:
                    allGoalsMet = False
            if not allGoalsMet: #**if** not _allGoalsMet_ **then** continue 
                continue
            #goalsAreMutex_ <- _false_ 
            goalsAreMutex = False
